    ...
    return (
      <div className="card-container">
        <div className="confirmed card">
          <p>Confirmed</p>
          <img
            src="https://res.cloudinary.com/dhexuirow/image/upload/v1626265472/Group_Tick_Mark_e6ywe0_wk0uuw.png"
            alt="confirmed-log"
          />
        ...
        <div className="tested card">
          <p>Active</p>
          <img
            src="https://res.cloudinary.com/dhexuirow/image/upload/v1626265472/Active_iagatt_vrh5fw.png"
            alt="active-log"
          />
        ...
        <div className="recovered card">
          <p>Recovered</p>
          <img
            src="https://res.cloudinary.com/dhexuirow/image/upload/v1626265472/Recovered_yisgwk_hcwfrl.png"
            alt="recovered-log"
          />
        ...
        <div className="deceased card">
          <p>Deceased</p>
          <img
            src="https://res.cloudinary.com/dhexuirow/image/upload/v1626265472/Deceased_mnzfxo_ddj6qp.png"
            alt="active-log"
          />
